<template>
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      数据列表 <span style="font-size: 14px;color: #9aaabf"> (品牌最多只能推荐4个)</span>

      <el-button style="float:right;" @click="add" :disabled="list.length>3"> 添加品牌</el-button>
    </el-card>
    <div style="margin-top: 20px;">
      ...
      >
        ...
        <el-table-column label="品牌名" align="center" width="800px">
    ...
    >
      ...
      <div class="pagination-container">
        <el-pagination
          ...
          :page-size="BrandQuery.pageSize"
          :page-sizes="[5,10]"
          :current-page.sync="BrandQuery.pageNum"
          :total="brandTotal">
        </el-pagination>
      </div>
      <div>
...
<script>
  ...
  import {addBrandRecommend,getBrandList,setSort,deleteBrand} from "../../api/recommend"
  const brandQuery = {
    pageNum: 1,
    pageSize: 5
  }
  ...
  export default {
    ...
    data(){
      return{
        ...
        BrandQuery: Object.assign({}, brandQuery),
    ...
    methods:{
      ...
      getBrandList(){
        getList(this.BrandQuery).then(res=>{
      ...
      handleSizeChange(val) {
        ...
        this.BrandQuery.pageSize = val;
        this.getBrandList();
      },
      // 推荐
      addRecommend(){
        this.recommend.brandId=this.currentRow.id
        this.recommend.brandName=this.currentRow.name
        this.recommend.url=this.currentRow.logo
        addBrandRecommend(this.recommend).then(res=>{
